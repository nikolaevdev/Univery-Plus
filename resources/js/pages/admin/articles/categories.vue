...
export default {
  ...
  metaInfo () {
    return { title: this.$t('admin_articles_categories') }
  },
  ...
  methods: {
    ...
    save_edit_Field(index, record) {
      ...
      axios.post('/api/admin/articles.categories.save', {
        id: record,
    ...
    save_add_Field() {
      ...
      axios.post('/api/admin/articles.categories.add', {
      ...
      if(!id || index === null)
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            axios.post('/api/admin/articles.categories.delete', {
              id: id,
              headers: {
                  'Content-Type': 'application/json'
              }
