<template>
  <div class="module">
  	<div class="mb-3 d-flex justify-content-between">
  		<h5 class="text-dark align-middle mb-0">{{$t('admin_university_information_use')}}</h5>
...
export default {
  ...
  metaInfo () {
    return { title: this.$t('admin_university_information_use') }
  },
  ...
  methods: {
    fetchData() {
      ...
      this.loading = true
      axios
        .get('/api/admin/information.use.get')
        .then(response => {
    ...
    save_edit_Field(index, record) {
      ...
      axios.post('/api/admin/information.use.save', {
        id: record,
    ...
    save_add_Field() {
      ...
      axios.post('/api/admin/information.use.add', {
      ...
      if(!id || index === null)
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            axios.post('/api/admin/information.use.delete', {
              id: id,
              headers: {
                  'Content-Type': 'application/json'
              }
