...
export default {
  ...
  metaInfo () {
    return { title: this.$t('admin_news_categories') }
  },
  ...
  methods: {
    ...
    save_edit_Field(index, record) {
      ...
      axios.post('/api/admin/news.categories.save', {
        id: record,
    ...
    save_add_Field() {
      ...
      axios.post('/api/admin/news.categories.add', {
      ...
      if(!id || index === null)
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            axios.post('/api/admin/news.categories.delete', {
              id: id,
              headers: {
                  'Content-Type': 'application/json'
              }
