			...
			<div>
				...
				<div class="row">
					<div class="col-12 col-lg-9">
						<div class="ml-lg-4 p-4 blog-main">
...
export default {
    ...
    metaInfo () {
        return { title: this.articles_name ? this.articles_name : this.$t('info_articles')}
    },
    ...
    methods: {
    	fetchData() {
            ...
            if(this.isInt(this.$route.params.id)){
	          ...
	          this.$router.push({ name: 'info.articles' })
	        }
		},
		item() {
